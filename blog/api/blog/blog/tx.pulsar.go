...
var (
	...
	fd_MsgGrantPermission_id      protoreflect.FieldDescriptor
	fd_MsgGrantPermission_grantee protoreflect.FieldDescriptor
)

func init() {
	file_blog_blog_tx_proto_init()
	md_MsgGrantPermission = File_blog_blog_tx_proto.Messages().ByName("MsgGrantPermission")
	fd_MsgGrantPermission_creator = md_MsgGrantPermission.Fields().ByName("creator")
	fd_MsgGrantPermission_id = md_MsgGrantPermission.Fields().ByName("id")
...
func (x *fastReflection_MsgGrantPermission) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Id != uint64(0) {
		value := protoreflect.ValueOfUint64(x.Id)
		if !f(fd_MsgGrantPermission_id, value) {
			return
		}
	}
	if x.Grantee != "" {
...
func (x *fastReflection_MsgGrantPermission) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "blog.blog.MsgGrantPermission.creator":
		return x.Creator != ""
	case "blog.blog.MsgGrantPermission.id":
		return x.Id != uint64(0)
	case "blog.blog.MsgGrantPermission.grantee":
		return x.Grantee != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: blog.blog.MsgGrantPermission"))
		}
		panic(fmt.Errorf("message blog.blog.MsgGrantPermission does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgGrantPermission) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message blog.blog.MsgGrantPermission does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgGrantPermission) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "blog.blog.MsgGrantPermission.creator":
		panic(fmt.Errorf("field creator of message blog.blog.MsgGrantPermission is not mutable"))
	case "blog.blog.MsgGrantPermission.id":
		panic(fmt.Errorf("field id of message blog.blog.MsgGrantPermission is not mutable"))
	case "blog.blog.MsgGrantPermission.grantee":
		panic(fmt.Errorf("field grantee of message blog.blog.MsgGrantPermission is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: blog.blog.MsgGrantPermission"))
		}
...
func (x *fastReflection_MsgGrantPermission) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in blog.blog.MsgGrantPermission", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_blog_blog_tx_proto_init()
	md_MsgGrantPermissionResponse = File_blog_blog_tx_proto.Messages().ByName("MsgGrantPermissionResponse")
}
...
func (x *fastReflection_MsgGrantPermissionResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: blog.blog.MsgGrantPermissionResponse"))
		}
		panic(fmt.Errorf("message blog.blog.MsgGrantPermissionResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgGrantPermissionResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message blog.blog.MsgGrantPermissionResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgGrantPermissionResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in blog.blog.MsgGrantPermissionResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *MsgGrantPermission) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_blog_blog_tx_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x66, 0x0a, 0x12, 0x4d,
	0x73, 0x67, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f,
	...
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x67,
	0x72, 0x61, 0x6e, 0x74, 0x65, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x67, 0x72,
	0x61, 0x6e, 0x74, 0x65, 0x65, 0x3a, 0x0c, 0x82, 0xe7, 0xb0, 0x2a, 0x07, 0x63, 0x72, 0x65, 0x61,
	0x74, 0x6f, 0x72, 0x22, 0x1c, 0x0a, 0x1a, 0x4d, 0x73, 0x67, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x50,
	0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x32, 0x93, 0x03, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x4e, 0x0a, 0x0c, 0x55, 0x70, 0x64,
	...
	0x6e, 0x73, 0x65, 0x12, 0x48, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x73,
	0x74, 0x12, 0x18, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x4d, 0x73,
	0x67, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x62, 0x6c,
	...
	,
...
var file_blog_blog_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_blog_blog_tx_proto_goTypes = []interface{}{
	...
	(*MsgGrantPermission)(nil),         // 8: blog.blog.MsgGrantPermission
	(*MsgGrantPermissionResponse)(nil), // 9: blog.blog.MsgGrantPermissionResponse
	(*Params)(nil),                     // 10: blog.blog.Params
}
var file_blog_blog_tx_proto_depIdxs = []int32{
	10, // 0: blog.blog.MsgUpdateParams.params:type_name -> blog.blog.Params
	...
	8,  // 5: blog.blog.Msg.GrantPermission:input_type -> blog.blog.MsgGrantPermission
	1,  // 6: blog.blog.Msg.UpdateParams:output_type -> blog.blog.MsgUpdateParamsResponse
	3,  // 7: blog.blog.Msg.CreatePost:output_type -> blog.blog.MsgCreatePostResponse
	5,  // 8: blog.blog.Msg.UpdatePost:output_type -> blog.blog.MsgUpdatePostResponse
	7,  // 9: blog.blog.Msg.DeletePost:output_type -> blog.blog.MsgDeletePostResponse
	9,  // 10: blog.blog.Msg.GrantPermission:output_type -> blog.blog.MsgGrantPermissionResponse
